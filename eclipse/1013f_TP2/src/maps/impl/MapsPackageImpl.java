...
public class MapsPackageImpl extends EPackageImpl implements MapsPackage {
	 ...
	 * @generated
	 */
	private EClass boulevardEClass = null;
	 ...
	 * @generated
	 */
	public EClass getBoulevard() {
		return boulevardEClass;
	}
	...
	public void createPackageContents() {
		...
		boulevardEClass = createEClass(BOULEVARD);
	...
	public void initializePackageContents() {
		...
		boulevardEClass.getESuperTypes().add(this.getRoad());
		...
		initEClass(boulevardEClass, Boulevard.class, "Boulevard", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
