...
public interface MapsPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int PUBLIC_SPACE__BORDERED_BY = 0;
	...
	/**
	 * The meta object id for the '{@link maps.impl.BoulevardImpl <em>Boulevard</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see maps.impl.BoulevardImpl
	 * @see maps.impl.MapsPackageImpl#getBoulevard()
	 * @generated
	 */
	int BOULEVARD = 4;
	 ...
	 * @ordered
	 */
	int BOULEVARD__BORDER = ROAD__BORDER;
	 ...
	 * @ordered
	 */
	int BOULEVARD__NAME = ROAD__NAME;
	 ...
	 * @ordered
	 */
	int BOULEVARD__LENGTH = ROAD__LENGTH;
	 ...
	 * @ordered
	 */
	int BOULEVARD__MEET = ROAD__MEET;

	/**
	 * The number of structural features of the '<em>Boulevard</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int BOULEVARD_FEATURE_COUNT = ROAD_FEATURE_COUNT + 0;

	/**
	 * The number of operations of the '<em>Boulevard</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int BOULEVARD_OPERATION_COUNT = ROAD_OPERATION_COUNT + 0;
	...
	/**
	 * Returns the meta object for class '{@link maps.Boulevard <em>Boulevard</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Boulevard</em>'.
	 * @see maps.Boulevard
	 * @generated
	 */
	EClass getBoulevard();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link maps.impl.BoulevardImpl <em>Boulevard</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see maps.impl.BoulevardImpl
		 * @see maps.impl.MapsPackageImpl#getBoulevard()
		 * @generated
		 */
		EClass BOULEVARD = eINSTANCE.getBoulevard();
