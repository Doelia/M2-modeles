...
public class ValueSpecificationActionImpl extends ActionImpl implements ValueSpecificationAction {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case UmlPackage.VALUE_SPECIFICATION_ACTION___COMPATIBLE_TYPE__DIAGNOSTICCHAIN_MAP:
				return compatible_type((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case UmlPackage.VALUE_SPECIFICATION_ACTION___MULTIPLICITY__DIAGNOSTICCHAIN_MAP:
