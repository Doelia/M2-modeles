...
public class StructuredActivityNodeImpl extends ActionImpl implements StructuredActivityNode {
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == ActivityGroup.class) {
			switch (baseOperationID) {
				...
				case UmlPackage.ACTIVITY_GROUP___GROUP_OWNED__DIAGNOSTICCHAIN_MAP: return UmlPackage.STRUCTURED_ACTIVITY_NODE___GROUP_OWNED__DIAGNOSTICCHAIN_MAP;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case UmlPackage.STRUCTURED_ACTIVITY_NODE___GROUP_OWNED__DIAGNOSTICCHAIN_MAP:
