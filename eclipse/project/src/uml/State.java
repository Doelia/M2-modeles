...
public interface State extends Namespace, RedefinableElement, Vertex {
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * A simple state is a state without any regions. result = region.isEmpty()
	 * <!-- end-model-doc -->
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * A composite state is a state with at least one region. result = region.notEmpty()
	 * <!-- end-model-doc -->
	 * @model kind="operation" dataType="uml.Boolean" required="true" ordered="false"
	 * @generated
	 */
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * An orthogonal state is a composite state with at least 2 regions result = (region->size () > 1)
	 * <!-- end-model-doc -->
	 * @model kind="operation" dataType="uml.Boolean" required="true" ordered="false"
	 * @generated
	 */
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * Only submachine states can have a reference statemachine. result = submachine.notEmpty()
	 * <!-- end-model-doc -->
	 * @model kind="operation" dataType="uml.Boolean" required="true" ordered="false"
	 * @generated
	 */
