...
public class UmlValidator extends EObjectValidator {
	...
	public boolean validateOutputPin(OutputPin outputPin, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateActivityNode_owned_structured_node(outputPin, diagnostics, context);
		...
		if (result || diagnostics != null) result &= validateObjectNode_not_unique(outputPin, diagnostics, context);
		...
		if (result || diagnostics != null) result &= validateMultiplicityElement_upper_gt_0(outputPin, diagnostics, context);
	...
	public boolean validateInputPin(InputPin inputPin, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateActivityNode_owned_structured_node(inputPin, diagnostics, context);
		...
		if (result || diagnostics != null) result &= validateObjectNode_not_unique(inputPin, diagnostics, context);
		...
		if (result || diagnostics != null) result &= validateMultiplicityElement_upper_gt_0(inputPin, diagnostics, context);
	...
	public boolean validateValuePin(ValuePin valuePin, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateActivityNode_owned_structured_node(valuePin, diagnostics, context);
		...
		if (result || diagnostics != null) result &= validateObjectNode_not_unique(valuePin, diagnostics, context);
		...
		if (result || diagnostics != null) result &= validateMultiplicityElement_upper_gt_0(valuePin, diagnostics, context);
	...
	public boolean validateActionInputPin(ActionInputPin actionInputPin, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateActivityNode_owned_structured_node(actionInputPin, diagnostics, context);
		...
		if (result || diagnostics != null) result &= validateObjectNode_not_unique(actionInputPin, diagnostics, context);
		...
		if (result || diagnostics != null) result &= validateMultiplicityElement_upper_gt_0(actionInputPin, diagnostics, context);
