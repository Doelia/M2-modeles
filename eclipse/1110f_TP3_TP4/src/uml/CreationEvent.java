...
public interface CreationEvent extends Event {
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * No othet OccurrenceSpecification may appear above an OccurrenceSpecification which references a CreationEvent on a given Lifeline in an InteractionOperand. true
