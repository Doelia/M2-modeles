...
public class ExpansionRegionImpl extends StructuredActivityNodeImpl implements ExpansionRegion {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case UmlPackage.EXPANSION_REGION___EXPANSION_NODES__DIAGNOSTICCHAIN_MAP:
				return expansion_nodes((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
		}
