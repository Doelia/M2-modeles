	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == MultiplicityElement.class) {
			switch (baseOperationID) {
				case UmlPackage.MULTIPLICITY_ELEMENT___UPPER_GT_0__DIAGNOSTICCHAIN_MAP: return UmlPackage.PARAMETER___UPPER_GT_0__DIAGNOSTICCHAIN_MAP;
				...
				case UmlPackage.MULTIPLICITY_ELEMENT___INCLUDES_CARDINALITY__INT: return UmlPackage.PARAMETER___INCLUDES_CARDINALITY__INT;
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case UmlPackage.PARAMETER___SET_NULL_DEFAULT_VALUE:
				setNullDefaultValue();
				return null;
			case UmlPackage.PARAMETER___UPPER_GT_0__DIAGNOSTICCHAIN_MAP:
