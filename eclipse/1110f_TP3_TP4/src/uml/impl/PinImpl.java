...
public class PinImpl extends ObjectNodeImpl implements Pin {
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == MultiplicityElement.class) {
			switch (baseOperationID) {
				case UmlPackage.MULTIPLICITY_ELEMENT___UPPER_GT_0__DIAGNOSTICCHAIN_MAP: return UmlPackage.PIN___UPPER_GT_0__DIAGNOSTICCHAIN_MAP;
				...
				case UmlPackage.MULTIPLICITY_ELEMENT___INCLUDES_CARDINALITY__INT: return UmlPackage.PIN___INCLUDES_CARDINALITY__INT;
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case UmlPackage.PIN___UPPER_GT_0__DIAGNOSTICCHAIN_MAP:
			...
			case UmlPackage.PIN___INCLUDES_CARDINALITY__INT:
