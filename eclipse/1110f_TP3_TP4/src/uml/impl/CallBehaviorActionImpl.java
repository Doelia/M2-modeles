...
public class CallBehaviorActionImpl extends CallActionImpl implements CallBehaviorAction {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case UmlPackage.CALL_BEHAVIOR_ACTION___ARGUMENT_PIN_EQUAL_PARAMETER__DIAGNOSTICCHAIN_MAP:
				return argument_pin_equal_parameter((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case UmlPackage.CALL_BEHAVIOR_ACTION___RESULT_PIN_EQUAL_PARAMETER__DIAGNOSTICCHAIN_MAP:
