...
public class RemoveVariableValueActionImpl extends WriteVariableActionImpl implements RemoveVariableValueAction {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case UmlPackage.REMOVE_VARIABLE_VALUE_ACTION___UNLIMITED_NATURAL__DIAGNOSTICCHAIN_MAP:
				return unlimited_natural((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
		}
