...
public abstract class ActivityNodeImpl extends RedefinableElementImpl implements ActivityNode {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case UmlPackage.ACTIVITY_NODE___OWNED_STRUCTURED_NODE__DIAGNOSTICCHAIN_MAP:
				return owned_structured_node((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case UmlPackage.ACTIVITY_NODE___OWNED__DIAGNOSTICCHAIN_MAP:
