...
public abstract class InvocationActionImpl extends ActionImpl implements InvocationAction {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case UmlPackage.INVOCATION_ACTION___ON_PORT_RECEIVER__DIAGNOSTICCHAIN_MAP:
				return on_port_receiver((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
		}
