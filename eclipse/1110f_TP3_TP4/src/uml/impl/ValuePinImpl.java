...
public class ValuePinImpl extends InputPinImpl implements ValuePin {
	...
	public NotificationChain basicSetValue(ValueSpecification newValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UmlPackage.VALUE_PIN__VALUE, oldValue, newValue);
	...
	public void setValue(ValueSpecification newValue) {
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject)value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UmlPackage.VALUE_PIN__VALUE, null, msgs);
			if (newValue != null)
				msgs = ((InternalEObject)newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UmlPackage.VALUE_PIN__VALUE, null, msgs);
