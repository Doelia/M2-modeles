...
public class ReadSelfActionImpl extends ActionImpl implements ReadSelfAction {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case UmlPackage.READ_SELF_ACTION___CONTAINED__DIAGNOSTICCHAIN_MAP:
				return contained((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case UmlPackage.READ_SELF_ACTION___NOT_STATIC__DIAGNOSTICCHAIN_MAP:
				return not_static((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case UmlPackage.READ_SELF_ACTION___TYPE__DIAGNOSTICCHAIN_MAP:
				return type((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case UmlPackage.READ_SELF_ACTION___MULTIPLICITY__DIAGNOSTICCHAIN_MAP:
