...
public class RemoveStructuralFeatureValueActionImpl extends WriteStructuralFeatureActionImpl implements RemoveStructuralFeatureValueAction {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case UmlPackage.REMOVE_STRUCTURAL_FEATURE_VALUE_ACTION___NON_UNIQUE_REMOVAL__DIAGNOSTICCHAIN_MAP:
				return non_unique_removal((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
		}
