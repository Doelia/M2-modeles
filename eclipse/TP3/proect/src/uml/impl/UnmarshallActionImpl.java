...
public class UnmarshallActionImpl extends ActionImpl implements UnmarshallAction {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case UmlPackage.UNMARSHALL_ACTION___SAME_TYPE__DIAGNOSTICCHAIN_MAP:
			...
			case UmlPackage.UNMARSHALL_ACTION___TYPE_AND_ORDERING__DIAGNOSTICCHAIN_MAP:
				return type_and_ordering((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case UmlPackage.UNMARSHALL_ACTION___MULTIPLICITY_OF_RESULT__DIAGNOSTICCHAIN_MAP:
			...
			case UmlPackage.UNMARSHALL_ACTION___UNMARSHALL_TYPE_IS_CLASSIFIER__DIAGNOSTICCHAIN_MAP:
				return unmarshallType_is_classifier((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
		}
