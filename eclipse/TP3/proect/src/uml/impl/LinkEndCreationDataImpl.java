...
public class LinkEndCreationDataImpl extends LinkEndDataImpl implements LinkEndCreationData {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case UmlPackage.LINK_END_CREATION_DATA___CREATE_LINK_ACTION__DIAGNOSTICCHAIN_MAP:
				return create_link_action((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case UmlPackage.LINK_END_CREATION_DATA___SINGLE_INPUT_PIN__DIAGNOSTICCHAIN_MAP:
