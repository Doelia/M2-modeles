	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case UmlPackage.ELEMENT___GET_RELATIONSHIPS__ECLASS:
				return getRelationships((ecore.EClass)arguments.get(0));
			...
			case UmlPackage.ELEMENT___GET_SOURCE_DIRECTED_RELATIONSHIPS__ECLASS:
				return getSourceDirectedRelationships((ecore.EClass)arguments.get(0));
			...
			case UmlPackage.ELEMENT___GET_TARGET_DIRECTED_RELATIONSHIPS__ECLASS:
				return getTargetDirectedRelationships((ecore.EClass)arguments.get(0));
