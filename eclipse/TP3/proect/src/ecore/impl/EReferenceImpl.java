...
public class EReferenceImpl extends EStructuralFeatureImpl implements EReference {
	 ...
	 * @generated
	 */
	public ecore.EClass getEReferenceType() {
		ecore.EClass eReferenceType = basicGetEReferenceType();
		return eReferenceType != null && eReferenceType.eIsProxy() ? (ecore.EClass)eResolveProxy((InternalEObject)eReferenceType) : eReferenceType;
	}
	 ...
	 * @generated
	 */
	public ecore.EClass basicGetEReferenceType() {
